				...
				<div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <form action="#" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" id="contact_email" class="form-control" placeholder="Adresse Email" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <textarea id="contact_message" class="form-control" rows="9" placeholder="Votre message"></textarea>
                            </div>
